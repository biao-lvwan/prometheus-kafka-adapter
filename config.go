...
func init() {
	...
	if value := os.Getenv("NUMPARTITION"); value != "" {
		numPartitionValue = value
	}

	if value := os.Getenv("REPLICATION_FACTOR"); value != "" {
		replicationFactorValue = value
	}
